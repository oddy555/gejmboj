...
void add_8(int& cycles,Register8 f,Register8& r1,uint16_t r2);
void adc(int& cycles,Register8 f, Register8& r1,Register8& r2);
void adc(int& cycles,Register8 f, Register8& r1,uint16_t r2);
void sub_8(int& cycles,Register8 f ,Register8& r1,Register8& r2);
void subc(int& cycles,Register8 f,Register8& r1,Register8& r2);
void sub_8(int& cycles,Register8 f ,Register8& r1,uint16_t r2);
void subc(int& cycles,Register8 f,Register8& r1,uint16_t r2);
void and_8(int &cycles,Register8 f, uint8_t &r1,Register8& r2);
void or_8(int &cycles,Register8 f, uint8_t &r1,uint8_t &r2);
void xor_8(int &cycles,Register8 f, uint8_t &r1,Register8& r2);
void cp_8(int& cycles,Register8 f ,Register8& r1,Register8& r2);
void cp_8(int& cycles,Register8 f ,Register8& r1,uint16_t r2);
...
void add_16(int& cycles,Register8 f,Register16& r1,Register16& r2);
...
void RLCA(int& cycles,Register8 f,Register8& r);
